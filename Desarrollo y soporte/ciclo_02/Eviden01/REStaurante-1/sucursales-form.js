        ...
        (result) => {
            if (result.isConfirmed) {
                ...
                var objSucursal = JSON.stringify({
                    ...
                    lugares: document.getElementById("cboLugares").value,
                    direccion: document.getElementById("txtDireccion").value,
                    telefono: document.getElementById("txtTelefono").value,
                    horario: document.getElementById("cboHorario").value,
    ...
    if (idForm > 0) {
        for (const i in tablaSucursal) {// BUSCAR EL Sucursal EN LA TABLA
            ...
            if (varSucursal.idLocal == idForm) { // COMPARAMOS IDLOCAL CON EL IDFORM
                ...
                document.getElementById("cboLugares").value = varSucursal.lugares;
                ...
                document.getElementById("cboHorario").value = varSucursal.horario;
